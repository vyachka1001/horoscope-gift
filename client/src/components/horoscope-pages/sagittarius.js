...
export default class HoroscopeSagittarius extends  React.Component {
    ...
    render() {
        ...
        <Container> 
            ...
            <HoroscopeContainer>
              <section id='aries'>
              <h2>Sagittarius horoscope for today</h2>
              <h5><ShowDate /></h5>
              ...
              <ContainerInfo>
                <InfoTable>
                  ...
                  <InfoColumns>
                    ...
                    <Column2>
                        <InfoIcon><IoBrushSharp/></InfoIcon>
                        <Text>Creative</Text>  
                      </Column2>
                    <Column3>
                  ...
                  <CharacteristicContainer>
                    <Characteristic>Sagittarius is a sign of the element of Fire, has a pronounced charisma of a leader, strives for education, is energetic and passionate about the idea of ​​​​changing the whole world. All his life, Sagittarius strives for popularity, for a high appreciation of his work and achievements from loved ones. Sagittarius almost always succeeds in at least one of their many activities. An energetic Sagittarius by nature usually has several specialties, a wide range of interests and business connections. Their business, participation in public life are often accompanied by teaching or political activities.</Characteristic>
                  </CharacteristicContainer>
                </InfoTable>
              </ContainerInfo>
            </InfoSection>
