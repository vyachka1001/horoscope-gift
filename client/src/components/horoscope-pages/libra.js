...
export default class HoroscopeLibra extends  React.Component {
    ...
    render() {
        ...
        <Container> 
            ...
            <HoroscopeContainer>
              <section id='aries'>
              <h2>Libra horoscope for today</h2>
              <h5><ShowDate /></h5>
              <div className="container horoscope_aries_container">
                ...
                <div className="right_column">
                  <div className="aries_cards">
                    ...
                    <article className="card">
                      <StyledIcons><BsWind/></StyledIcons>
                      <Styledh5>Wind</Styledh5>
            ...
            <InfoSection>
              <ContainerInfo>
                <InfoTable>
                  ...
                  <InfoColumns>
                    <Column1>
                        <InfoIcon><GiOldMicrophone/></InfoIcon>
                        <Text>Artistic</Text>
                    </Column1>
                    <Column2>
                    ...
                    <Column3>
                        <InfoIcon><IoBriefcase/></InfoIcon>
                        <Text>Diplomatic</Text>  
                    </Column3>
                  </InfoColumns>
                  <CharacteristicContainer>
                      <Characteristic>The only inanimate symbol in the zodiac circle, Libra is the second sign of the element of Air. A distinctive feature of the representatives of this sign is the desire for harmony in everything. Sensitive to the beautiful, born diplomats, with fortitude and an unbending will to win in any rivalry, Libra often act as judges, as well as lawyers at all levels. Constancy, reliability and creative power are the best qualities of this sign.</Characteristic>
                  </CharacteristicContainer>
                </InfoTable>
              </ContainerInfo>
            </InfoSection>
