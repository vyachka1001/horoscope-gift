...
export default class HoroscopeCapricorn extends  React.Component {
    ...
    render() {
        ...
        <Container> 
            ...
            <HoroscopeContainer>
              <section id='aries'>
              <h2>Capricorn horoscope for today</h2>
              <h5><ShowDate /></h5>
              ...
              <ContainerInfo>
                <InfoTable>
                  ...
                  <CharacteristicContainer>
                    <Characteristic>Capricorn, the tenth sign and mountain goat of the zodiac, is all about hard work. Those born under this sign are more than happy to put in a full day at the office, realizing that it will likely take a lot of those days to get to the top. That’s no problem, since Capricorns are both ambitious and determined: they will get there. Life is one big project for these folks, and they adapt to this by adopting a businesslike approach to most everything they do.<br />
                    
Capricorns are practical as well, taking things one step at a time and being as realistic and pragmatic as possible. </Characteristic>
                  </CharacteristicContainer>
                </InfoTable>
              </ContainerInfo>
            </InfoSection>
